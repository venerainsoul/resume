...
var header = {
  ...
  address: 'Kyiv, Antonovycha street, 18',
}
var footer = {
  social: {
    email: {
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      education: [
        {
          name: 'O.S. Popov Odesa National Academy of Telecommunications, 2014',
          isEnd: true,
        },
        {
          name: 'Kyiv Applied College of telecommunications, 2011',
          isEnd: true,
        },
        {
          name: 'National Pedagogical Drahomanov University, 2017',
          isEnd: false,
        },
      ],
      certificates: [
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Trello brings all your tasks, teammates, and tools together',
                },
                {
                  name: 'Keep everything in the same place—even if your team isn’t',
                },
              ],
              awardAmount: 2,
            },
